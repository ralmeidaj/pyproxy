...
function submit() {
    ...
    form.transform(() => payload).post(route('backoffice.tenants.api-keys.store', props.tenant.id))
}
    ...
    <BackofficeLayout>
        ...
        <div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <!-- Aviso -->
                <div class="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-2xl px-5 py-4 text-sm text-amber-800">
                    <span class="text-lg flex-shrink-0">⚠️</span>
                    <p>A chave será exibida <strong>uma única vez</strong> após a criação. Salve-a em local seguro imediatamente.</p>
                </div>
                ...
                <div class="flex items-center gap-3 pt-1">
                    <button type="submit" :disabled="form.processing"
                        ...
                        {{ form.processing ? 'Gerando…' : 'Gerar API Key' }}
                    </button>
